...
function loop() {
  ...
  for(let index = vertices.length -1; index > -1; --index){
    ...
    let myX = (vertices[index].x);
    let myY = (vertices[index].y);
    if(index == 0){context.strokeText("LARAVEL", myX, myY);}
    if(index == 1){context.strokeText("CSS", myX, myY);}
    if(index == 2){context.strokeText("SCSS", myX, myY);}
    if(index == 3){context.strokeText("REACT", myX, myY);}
    if(index == 4){context.strokeText("HTML", myX, myY);}
    if(index == 5){context.strokeText("JAVASCRIPT", myX, myY);}
    if(index == 6){context.strokeText("MYSQL", myX, myY);}
    if(index == 7){context.strokeText("PHP", myX, myY);}

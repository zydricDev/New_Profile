...
exports.default = _default;
},{"@dogstudio/highway":"node_modules/@dogstudio/highway/build/highway.module.js","gsap":"node_modules/gsap/index.js"}],"js/mapLoad.js":[function(require,module,exports) {
"use strict";
...
var MapLoad = /*#__PURE__*/function (_Highway$Renderer) {
  ...
  var _super = _createSuper(MapLoad);

  function MapLoad() {
    _classCallCheck(this, MapLoad);

    return _super.apply(this, arguments);
  }

  _createClass(MapLoad, [{
    key: "onEnter",
    value: function onEnter() {
      var tl = new _gsap.TimelineLite();
      var element = document.getElementById('switch_view');
      tl.fromTo(element.children[0], 1, {
        ...
        onComplete: function onComplete() {
          ...
          var script = document.createElement('script');
          var key = "AIzaSyCxz3AG8xxfMuXMbR5ND5zL0Y8StCtNYNg";
